...
<br>
  ...
  This script was intended to be used for extracting visualizations already created in Kibana and write them into an HTML format email message. The supported visualizations are: 
